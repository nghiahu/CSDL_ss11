...
-- 3) Tạo một Composite Index (Index nhiều cột) trên cột BranchID và Salary của bảng Employees để tối ưu hóa truy vấn tìm kiếm nhân viên theo chi nhánh và mức lương.
